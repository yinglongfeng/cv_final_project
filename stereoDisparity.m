...
% $Author: ChrisMcCormick $    $Date: 20    14/01/10 22:00:00 $    $Revision: 1.0 $
...
function [ DbasicSubpixel ] = stereoDisparity(leftI, rightI, dispR, halfBS)
...
leftI = double(leftI);  % FYL  1
rightI = double(rightI); % FYL 1
% leftI = mean(leftI, 3);
